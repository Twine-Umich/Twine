...
import chisel3.twine.hardfloat._
import chisel3.twine.hardfloat.consts._
import scala.collection.mutable.ArrayBuffer

object TwineTool{

  def expandAndAddElements[T <: Data](simpleChiselBundle: TwineBundle[T], buffer:ArrayBuffer[Data]): Any ={
