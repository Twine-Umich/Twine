...
class SimpleChiselMiscellaneous{
    def findDecoupledRegion(sm: SimpleChiselModuleInternal):(ArrayBuffer[(SimpleChiselModuleInternal, SimpleChiselModuleInternal)]) = {
        val allDecoupledRegions = new ArrayBuffer[(SimpleChiselModuleInternal, SimpleChiselModuleInternal)]
    ...
    def findCrossRegion(sm: SimpleChiselModuleInternal):(ArrayBuffer[(SimpleChiselModuleInternal, SimpleChiselModuleInternal)]) = {
        val allCrossRegion = new ArrayBuffer[(SimpleChiselModuleInternal, SimpleChiselModuleInternal)]
    ...
    def findLockStepRegion(sm: SimpleChiselModuleInternal):(ArrayBuffer[ArrayBuffer[SimpleChiselModuleInternal]], ArrayBuffer[Int]) = {

        val allLockStepRegions = new ArrayBuffer[ArrayBuffer[SimpleChiselModuleInternal]]
        val allValidIOIdx = new ArrayBuffer[Int]
        val visited = new HashMap[SimpleChiselModuleInternal, Boolean]

        for(m <- sm.sub_modules){
            visited += (m -> false)
        }

        def searchForward(crnt_m: SimpleChiselModuleInternal, 
            crnt_list: ArrayBuffer[SimpleChiselModuleInternal], isValidIO: ArrayBuffer[Boolean] ): (ArrayBuffer[SimpleChiselModuleInternal], ArrayBuffer[Boolean]) = {
        ...
        def searchBackward(crnt_m: SimpleChiselModuleInternal, 
            crnt_list: ArrayBuffer[SimpleChiselModuleInternal], isValidIO: ArrayBuffer[Boolean] ): (ArrayBuffer[SimpleChiselModuleInternal], ArrayBuffer[Boolean]) = {
        ...
        breakable{
            while(true){
                var crnt_m: Option[SimpleChiselModuleInternal] = None
                breakable{
                ...
                var lockStepRegion = new ArrayBuffer[SimpleChiselModuleInternal]
