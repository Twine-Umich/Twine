...
object TwineSyncConnGen{

    def syncLSTranformation(parent: TwineModuleBase, 
        l_ctrl: TwineIOCtrlInternal, r_ctrl: LockStepIOCtrlInternal): Any ={
    ...
    def syncLITranformation(parent: TwineModuleBase, 
        l_ctrl: TwineIOCtrlInternal, r_ctrl: LatInsensitiveIOCtrlInternal): Any ={
    ...
    def apply(m: TwineModuleBase, 
        l_m: TwineModuleInternal, r_m: TwineModuleInternal): Any ={
        (l_m.ctrl, r_m.ctrl) match{
            case (l: TwineIOCtrlInternal, r: LockStepIOCtrlInternal) =>
                syncLSTranformation(m, l, r)
            case (l: TwineIOCtrlInternal, r: LatInsensitiveIOCtrlInternal) =>
